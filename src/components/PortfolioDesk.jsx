...
export function ScrollWatcher({ aboutRef, monitorRef, sideRef, phoneRef }) {
  ...
  useFrame(() => {
    ...
    // About card: fade in at books, fade out before monitor moves
    ...
    // Monitor + side: only show when camera is paused AT monitor
    ...
    // Phone: only show when camera is paused AT phone
